    ...
    return (
        <Collapsible.Root className="w-full" open={open} onOpenChange={setOpen}>
            ...
            {data.content.map((item)=>{
                return(
                <div className="flex flex-row items-center w-full justify-between bg-white rounded my-[10px] p-[10px] shadow-[0_2px_10px] shadow-blackA7">
                    ...
                    <div className='flex flex-row items-center justify-center gap-[10px]'>
                            ...
                            <ExclamationTriangleIcon className='w-[24px] h-[24px] bg-[#FBBF24]' />
                            {/* <ArrowRightIcon className='w-[24px] rounded-full border-[1px] h-[24px] bg-[#FBBF24]' /> */}
                        <Image src="/DialogBoxIcons/message.png" className='object-cover' width={24} height={24} style={{ color: "#9E9E9E" }} alt="avatar-logo" />
                        <DotsVerticalIcon className='w-[24px] h-[24px] text-[#9E9E9E]' />
                    </div>
