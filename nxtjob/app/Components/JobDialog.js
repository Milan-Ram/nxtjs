...
return(
  ...
  <Dialog.Root>
    <Dialog.Trigger asChild>
      <button className="text-violet11 shadow-blackA7 hover:bg-mauve3 flex  w-full rounded-[8px] flex-col bg-white p-[10px] gap-1 font-medium shadow-[0_2px_10px] focus:shadow-[0_0_0_2px] focus:shadow-black focus:outline-none">
        ...
        <div className='flex'>
            ...
            <div className='flex flex-col'>
                <h3 className='text-[#212121] text-[15px]'>{data.job_title}</h3>
                <div><h4 className='text-[#AFAFAF] text-[13px]'>data.compa</h4></div>
                </div>
                </div>
